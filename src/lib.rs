...
#[derive(Debug)]
pub struct ZilliqaAPIProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ZilliqaAPIProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ZilliqaAPI processing");
    
    let mut processor = ZilliqaAPIProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ZilliqaAPIProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ZilliqaAPIProcessor::new(false);
